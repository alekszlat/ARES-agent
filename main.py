...
#    backend.assistant_text.connect(bridge.setLastAssistantText)   # implement this property later
...
#    backend.error.connect(bridge.setLastError)                   # optional
    ...
    # Implement Bridge.sendRequested = Signal(str)
    # and Bridge.sendUserMessage(text) that emits sendRequested(text)
